<?php
class Aurigait_Voucher_Block_Adminhtml_Promo_Quote_Edit_Tab_Main extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Main
{
 protected function _prepareForm()
    {
        ...
        $couponCodeFiled = $fieldset->addField('coupon_code', 'text', array(
            ...
            'label' => Mage::helper('salesrule')->__('Coupon Code'),
        		'note' =>'Use :: <br> WELCOME => Welcome coupon<br> INVT-FRIENDNAME =>  AD-xxxx => Admin defined coupon sas<br>',
            'required' => true,
        ));
